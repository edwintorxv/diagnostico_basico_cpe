...
public class Constantes {
    ...
    //Mensajes de respuesta por validación FTTH
    public static final String FTTH_NO_ONLINE_CODIGO = "300";
    public static final String FTTH_NO_ONLINE_DESCRIPCION = "No es posible consultar la ONT.";

    public static final String FTTH_ONLINE_SIN_ULTRAWIFI_CANALES_ONLINE_CODIGO = "601";
    public static final String FTTH_ONLINE_SIN_ULTRAWIFI_CANALES_ONLINE_DESCRIPCION = "Topología de ONT correcta";

    public static final String FTTH_ONLINE_SIN_ULTRAWIFI_CANALES_OFFLINE_CODIGO = "602";
    public static final String FTTH_ONLINE_SIN_ULTRAWIFI_CANALES_OFFLINE_DESCRIPCION = "Canales deshabilitados en ONT";

    public static final String FTTH_ONLINE_CON_ULTRAWIFI_MAS_DE_DOS_MAC_CODIGO = "603";
    public static final String FTTH_ONLINE_CON_ULTRAWIFI_MAS_DE_DOS_MAC_DESCRIPCION = "Se detecta problema en Topología por más de 1 AP Maestro";

    public static final String FTTH_ONLINE_CON_ULTRAWIFI_NO_DETECTADA_APMAESTRO_CODIGO = "604";
    public static final String FTTH_ONLINE_CON_ULTRAWIFI_NO_DETECTADA_APMAESTRO_DESCRIPCION = "No se detecta UltraWiFi operativo, se debe validar daño y/o garantía de este";

    public static final String FTTH_ONLINE_CON_ULTRAWIFI_SIN_AP_ESCLAVO_CODIGO = "605";
    public static final String FTTH_ONLINE_CON_ULTRAWIFI_SIN_AP_ESCLAVO_DESCRIPCION = "No se encuentra AP Esclavo en la topología";

    public static final String FTTH_ONLINE_CON_ULTRAWIFI_CANALES_OFFLINE_CODIGO = "606";
    public static final String FTTH_ONLINE_CON_ULTRAWIFI_CANALES_OFFLINE_DESCRIPCION = "El UltraWifi no tiene encendidos ambos canales";

    public static final String FTTH_ONLINE_CON_ULTRAWIFI_CANALES_ONLINE_AP_ONT_CODIGO = "607";
    public static final String FTTH_ONLINE_CON_ULTRAWIFI_CANALES_ONLINE_AP_ONT_DESCRIPCION = "Se sugiere deshabilitar Canal 2.4 GHz y 5GHz en ONT";

    public static final String FTTH_ONLINE_CON_ULTRAWIFI_CANALES_OFFLINE_ONT_ONLINE_AP_CODIGO = "608";
    public static final String FTTH_ONLINE_CON_ULTRAWIFI_CANALES_OFFLINE_ONT_ONLINE_AP_DESCRIPCION = "Topología de ONT y UltraWiFi Correcta";
    ...
    //Mensajes de respuesta por validación HFC
